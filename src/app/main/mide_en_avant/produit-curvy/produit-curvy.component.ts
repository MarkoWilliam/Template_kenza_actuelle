...
@Component({
  selector: 'app-produit-curvy',
  templateUrl: './produit-curvy.component.html',
  styleUrls: ['./produit-curvy.component.scss']
})
export class ProduitCurvyComponent implements OnInit {
  ...
  async ListeProduit() {
   ...
   await this.servGlobal.getAllCurvy().subscribe(async results => {
...
let model={
  ...
  this.servGlobal.insertioncurvy(model).subscribe(results => {
...
return new Promise((resolve) => {
  this.servGlobal.getProduitCurvy().subscribe(results => {
